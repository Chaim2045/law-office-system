import {B as f} from './index-BPwXV1JT.js';class u {
constructor() {
...
const r=window.firebaseDB;if (!r) {
throw new Error('Firebase לא מחובר');
}console.log(`🕐 Starting real-time timesheet listener for: ${o}`);const n=r.collection('timesheet_entries').where('employee','==',o).limit(1e3).onSnapshot(i => {
