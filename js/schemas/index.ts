 ...
 */
export function validateClient(data: unknown): ValidationResult<Client> {
 ...
 */
export function validateBudgetTask(
  data: unknown
): ValidationResult<BudgetTask> {
...
export function validateTimesheetEntry(
  data: unknown
): ValidationResult<TimesheetEntry> {
 ...
 */
export function validateEmployee(data: unknown): ValidationResult<Employee> {
 ...
 */
export function validateLegalProcedure(
  data: unknown
): ValidationResult<LegalProcedure> {
