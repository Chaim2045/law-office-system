...
| E | Claim shape consolidation | _pending_ | 🟢 UNBLOCKED (2026-06-04 — verifyClaims-PROD run done; `admin_boolean_only:0` → near-no-op) | MEDIUM | B + D |
