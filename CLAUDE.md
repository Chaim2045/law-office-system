...
## ARCHIVED DOCS
`docs/archive/README.md` indexes superseded documentation kept for history only — nothing in `docs/archive/` describes the current system; never cite it as a reference.
