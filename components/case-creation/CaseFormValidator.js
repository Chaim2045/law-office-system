 ...
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * @description ולידציה מרכזית לטופס יצירת תיק
 * @version 1.0.0
 * @created 2025-12-07
 * @migrated-from js/modules/case-creation/case-form-validator.js (v3.0.0)
 *
 * @features
 * - ולידציה מלאה של טופס יצירת תיק
 * - תמיכה בלקוח חדש ולקוח קיים
 * - ולידציה לפי סוג שירות (שעות / הליך משפטי)
 * - הצגת שגיאות ואזהרות inline
 * - בדיקות טלפון ואימייל ישראלי
 */
...
export class CaseFormValidator {
  ...
  static validateCaseDetails(caseData) {
    ...
    } else if (window.CaseNumberGenerator?.isValidCaseNumber && !window.CaseNumberGenerator.isValidCaseNumber(caseData.caseNumber)) {
...
console.log('✅ CaseFormValidator v1.0 loaded (ES6 module)');
